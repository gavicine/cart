const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/ObbyCarts.loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/ObbyCarts.data.br",
            frameworkUrl: buildUrl + "/ObbyCarts.framework.js.br",
            codeUrl: buildUrl + "/ObbyCarts.wasm.br",
