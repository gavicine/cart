const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "https://cdn.jsdelivr.net/gh/gavicine/cart@main/ObbyCarts.loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "https://cdn.jsdelivr.net/gh/gavicine/cart@main/ObbyCarts.data.br",
            frameworkUrl: buildUrl + "https://cdn.jsdelivr.net/gh/gavicine/cart@main/ObbyCarts.framework.js.br",
            codeUrl: buildUrl + "https://app-422891.games.s3.yandex.net/422891/14ywo3okbpm9o6886lglzco5wbi9fy7j_brotli/Build/ObbyCarts.wasm.br",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "MaxDigitArt",
            productName: "Cart Ride Obby",
